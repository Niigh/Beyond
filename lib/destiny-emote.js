...
class DestinyEmote {
    ...
    getCraftingMaterialsEmote(materialName) {
        switch (materialName) {
            case 'Adroit Element':
                return this.adroitElement;
            case 'Energetic Element':
                return this.energeticElement;
            case 'Mutable Element':
                return this.mutableElement;
            case 'Ruinous Element':
                return this.ruinousElement;
            case 'Neutral Element':
                return this.neutralElement;
            case 'Drowned Element':
                return this.drownedElement;
            case 'Resonant Alloy':
                return this.resonantAlloy;
            case 'Ascendant Alloy':
                return this.ascendantAlloy;
            default:
                break;
        }
        err('Couldn\'t load the crafting material emote.');
        return '';
    }
    ...
    getAmmoTypeEmote(ammoType) {
        ...
        err('Couldn\'t load the ammo type emote.');
        return '';
    }
