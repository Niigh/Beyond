...
class EmbedBuilder {
    ...
    getWeaponEmbed(discordID, avatar, weaponSlot, weapon, weaponHash, weaponState, version, bungieTag=undefined) {
        destinyDB.loadDB();
        ...
        var intrinsicField;
        if (version == 'Detailed') {
            intrinsicField = `**${intrinsic.name} |** ${intrinsic.description}\n`;
        } else {
            intrinsicField = `**${intrinsic.name}**\n`;
        }
