...
class EmbedBuilder {
    ...
    getWeaponEmbed(discordID, avatar, weaponSlot, weapon, weaponHash, weaponState, bungieTag=undefined) {
        ...
        console.log(weapon.plugObjectives.data);
        // console.log(weapon.plugObjectives.data != undefined);
        // if(weapon.plugObjectives.data != undefined) {
        //     console.log(weapon.plugObjectives.data.objectivesPerPlug);
        //     if(weapon.plugObjectives.data.objectivesPerPlug["2302094943"] != undefined) {
        //         killTracker += `${destinyEmote.getKillTrackerEmote('PVE')} Enemies Defeated : ${weapon.plugObjectives.data.objectivesPerPlug["2302094943"][0].progress}\n`;
        //         console.log(killTracker);
        //     }
        //     console.log(weapon.plugObjectives.data.objectivesPerPlug["38912240"]);
        //     if(weapon.plugObjectives.data.objectivesPerPlug["38912240"] != undefined) {
        //         killTracker += `${destinyEmote.getKillTrackerEmote('PVE')} Enemies Defeated : ${weapon.plugObjectives.data.objectivesPerPlug["38912240"][0].progress}\n`;
        //         console.log(killTracker);
        //     }
        //     killTracker += '\n';
        // }
        ...
        const season = destinyDB.getSeason(weaponItem.collectibleHash);
        ...
        const weaponEmbed = {
            ...
            timestamp: new Date(),
            thumbnail: {
                url: bungieAPI.buildURLAsset(weaponItem.displayProperties.icon)
              },
            title: `${destinyEmote.getItemLockStateEmote(weaponState.includes('Locked'))}${weaponItem.displayProperties.name}`,
            ...
            fields: [],
            image : {
                url: bungieAPI.buildURLAsset(weaponItem.screenshot)
            }
        };
        destinyDB.closeDB();
        return weaponEmbed;
