...
class EmbedBuilder {
    ...
    getWeaponEmbed(discordID, avatar, weaponSlot, bungieTag=undefined) {
        destinyDB.loadDB();
    ...
    getArmorEmbed(discordID, avatar, armorSlot, bungieTag=undefined) {
        
    }

    getGhostEmbed(discordID, avatar, ghost, bungieTag=undefined) {
        
    }

    getSparrowEmbed(discordID, avatar, sparrow, bungieTag=undefined) {
        
    }

    getShipEmbed(discordID, avatar, ship, bungieTag=undefined) {
        
    }

    getEmblemEmbed(discordID, avatar, emblem, bungieTag=undefined) {
        
    }

    getSubclassEmbed(discordID, avatar, subclass, bungieTag=undefined) {
