...
class EmbedBuilder {
    ...
    getArmorEmbed(discordID, avatar, armorSlot, armor, armorHash, armorState, bungieTag=undefined) {
        ...
        //Stats
        console.log(armor.stats.data.stats);
        ...
        if(armorState.includes('Masterwork')) {
            statsField.value += `${destinyEmote.getStatEmote('Mobility')} ${mobility} **| ${mobility-2}** + 2\n`;
            statsField.value += `${destinyEmote.getStatEmote('Resilience')} ${resilience} **| ${resilience-2}** + 2\n`;
            statsField.value += `${destinyEmote.getStatEmote('Recovery')} ${recovery} **| ${recovery-2}** + 2\n`;
            statsField.value += `${destinyEmote.getStatEmote('Discipline')} ${discipline} **| ${discipline-2}** + 2\n`;
            statsField.value += `${destinyEmote.getStatEmote('Intellect')} ${intellect} **| ${intellect-2}** + 2\n`;
            statsField.value += `${destinyEmote.getStatEmote('Strength')} ${strength} **| ${strength-2}** + 2\n`;
        } else if (0) { //sockets.includs (check if there is any mods that improve or lessen a stat)
