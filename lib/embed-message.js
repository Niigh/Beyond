...
class EmbedBuilder {
    ...
    getWeaponEmbed(discordID, weaponSlot, bungieTag=undefined) {
        destinyDB.loadDB();
    ...
    getArmorEmbed(discordID, armorSlot, bungieTag=undefined) {
        
    }

    getGhostEmbed(discordID, ghost, bungieTag=undefined) {
        
    }

    getSparrowEmbed(discordID, sparrow, bungieTag=undefined) {
        
    }

    getShipEmbed(discordID, ship, bungieTag=undefined) {
        
    }

    getEmblemEmbed(discordID, emblem, bungieTag=undefined) {
        
    }

    getSubclassEmbed(discordID, subclass, bungieTag=undefined) {
