...
class EmbedBuilder {
    ...
    getWeaponEmbed(discordID, avatar, weaponSlot, weaponHash, bungieTag=undefined) {
        destinyDB.loadDB();
    ...
    getArmorEmbed(discordID, avatar, armorSlot, armorHash, bungieTag=undefined) {
        
    }

    getGhostEmbed(discordID, avatar, ghost, ghostHash, bungieTag=undefined) {
        destinyDB.loadDB();
        ...
        const ghostEmbed = {
            ...
            title: ghostItem.displayProperties.name,
    ...
    getSparrowEmbed(discordID, avatar, sparrow, sparrowHash, bungieTag=undefined) {
        
    }

    getShipEmbed(discordID, avatar, ship, shipHash, bungieTag=undefined) {
        
    }

    getEmblemEmbed(discordID, avatar, emblem, emblemHash, bungieTag=undefined) {
